...
export default function ServiceDetailPage({
    ...
    stats = [
        { label: "Investor Decks Built", value: "100+" },
        { label: "Founder Approval", value: "93%" },
        { label: "Focus", value: "Conviction" },
    ],
    heroMedia = {
        image1: "img11.png",
        image2: "img9.jpg",
        video:
            "https://res.cloudinary.com/dixhnqcby/video/upload/v1767780403/Video1_o1qqud.mp4",
    ...
    const process = [
        {
            title: "Understand",
            body: "Strategic + financial immersion.",
        },
        {
            title: "Position",
            body: "Define the investment story.",
        },
        {
            title: "Build",
            body: "Craft materials + communication systems.",
        },
        {
            title: "Engage",
            body: "Support fundraising + analyst relations.",
        },
        {
            title: "Communicate",
            body: "Contextualize performance + milestones.",
        },
        {
            title: "Evolve",
            body: "Ongoing narrative + stakeholder advisory.",
        },
    ];
                        ...
                        <div className="lg:col-span-4 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] h-full w-full">
                                <video
                                    ...
                                    src={"https://res.cloudinary.com/dixhnqcby/video/upload/v1766196622/Video1_khb7vz.mp4"}
                        ...
                        <div className="lg:col-span-3 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] h-full w-full">
                                <Image
                                    ...
                                    alt="Decks and stakeholder messaging visual"
                                    className="h-full w-full object-cover"
                                    loading="lazy"
                                />
                            </div>
                            ...
                            <div className="mt-8 border-t border-black/10 pt-8">
                                <div className="flex flex-wrap gap-3">
                                    <span className="rounded-full border border-black/10 bg-white/10 px-4 py-2 text-sm text-[#23352d]/80">
                                        100+ investor decks built.
                                    </span>
                                    <span className="rounded-full border border-black/10 bg-white/10 px-4 py-2 text-sm text-[#23352d]/80">
                                        93% founder approval rate.
                                    </span>
                                </div>
                            </div>
                        </div>
