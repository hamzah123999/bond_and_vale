...
const FooterIntro = memo(function FooterIntro() {
    return (
...
const FooterInstagram = memo(function FooterInstagram() {
    const items = useMemo(() => instaItems, []);
    ...
    return (
        <div className="md:mt-20 mt-16 ">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 md:gap-4 gap-2">
                {items.map((item, i) => (
                    <div key={i} className="group relative h-32 overflow-hidden">
                        <ParallaxImage
                            src={item.src}
                            alt={item.label}
            ...
            <div className="flex md:justify-center justify-between gap-6">
                <Link href="/terms-and-conditions" className="underline">
                    <DecryptedText
                        ...
                        className="text-[#0e221c] underline "
                        useOriginalCharsOnly
                        animateOn="hover"
                        parentClassName="text-[#0e221c] cursor-pointer underline    "
                        speed={50}
                    />
                </Link>
