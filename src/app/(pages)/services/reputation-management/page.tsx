...
export default function ServiceDetailPage({
    ...
    stats = [
        ...
        { label: "Support", value: "Real-Time" },
    ],
    heroMedia = {
        image1: "img13.png",
        image2: "img5.jpg",
        video:
            "https://res.cloudinary.com/dixhnqcby/video/upload/v1767780289/Video3_cxr2ou.mp4",
    ...
    const process = [
        {
            title: "Diagnose",
            body: "Understand strengths, vulnerabilities, and public sentiment.",
        },
        {
            title: "Re-shape Narrative",
            body: "Position the story you want to be known for.",
        },
        {
        ...
        {
            title: "Amplify",
            body: "Convert visibility into trust, influence, and opportunity.",
        },
        {
            title: "Protect",
            body: "Monitor, advise, and safeguard reputation in real time.",
        },
        {
            title: "Evolve",
            body: "Long-term advisory for continued trust and authority.",
        },
    ];
                        ...
                        <div className="lg:col-span-5 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] w-full">
                                <Image
                                    ...
                                    alt="Reputation Management visual"
                        ...
                        <div className="lg:col-span-4 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] h-full w-full">
                                <video
                                    ...
                                    src={"https://res.cloudinary.com/dixhnqcby/video/upload/v1766196639/Video3_v4rapo.mp4"}
                        ...
                        <div className="lg:col-span-3 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] h-full w-full">
                                <Image
                                    ...
                                    alt="Authority and trust visual"
                                    className="h-full w-full object-cover"
                                    loading="lazy"
                                />
                            </div>
