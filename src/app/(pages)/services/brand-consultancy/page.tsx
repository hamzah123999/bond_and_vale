...
export default function ServiceDetailPage({
    ...
    subtitle = "Build meaning. Build desire. Build a brand that lives beyond the page.",
    tags = [
        "Brand Strategy",
        "Positioning",
        "Identity System",
    ...
    const process = [
        {
            title: "Discovery",
            body: "Immerse. Observe. Understand.",
        },
        {
            title: "Positioning & Narrative",
            body: "Define the story only you can tell.",
        },
        {
            title: "Identity & Design",
            body: "Craft how that story looks, feels, and moves.",
        },
        {
            title: "Codification",
            body: "Systemize for consistency and scale.",
        },
        {
            title: "Activation",
            body: "Launch with clarity and orchestration.",
        },
        {
            title: "Advisory",
            body: "Evolve with intelligence.",
        },
    ];
