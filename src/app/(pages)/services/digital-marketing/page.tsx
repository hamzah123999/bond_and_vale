...
export default function ServiceDetailPage({
    ...
    tags = [
        ...
        "Senior-Led",
        "Full-Funnel",
        "Influence Over Impressions",
    ],
    stats = [
        { label: "Campaigns Executed", value: "100+" },
    ...
    const process = [
        ...
        },
        {
            ...
            body: "Develop narrative that moves people.",
        },
        {
            title: "Create",
            body: "Produce content and creative with purpose.",
        },
        {
            title: "Deploy",
            body: "Activate across core channels.",
        },
        {
            title: "Optimise",
            body: "Analyse, refine, improve.",
        },
        {
            title: "Scale",
            body: "Integrate with PR + brand growth.",
        },
    ];
                        ...
                        <div className="lg:col-span-4 overflow-hidden border border-black/10 bg-black/5">
                            <div className="relative aspect-[16/10] h-full w-full">
                                <video
                                    ...
                                    src={"https://res.cloudinary.com/dixhnqcby/video/upload/v1766196661/Video6_yebmco.mp4"}
